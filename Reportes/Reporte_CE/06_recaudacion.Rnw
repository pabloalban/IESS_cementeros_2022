...
En cuanto a la aplicación de intereses, el artículo único de la Ley Interpretativa menciona: “(…) El cálculo de los respectivos intereses se hará en atención al monto del correspondiente capital cuantificado conforme lo señalado en este artículo”. En cuanto a los intereses por mora, el Artículo 89 de la Ley de Seguridad Social establece que “(…) causará un interés equivalente al máximo convencional permitido por el Banco Central del Ecuador, a la fecha de liquidación de la mora, incrementado en cuatro puntos”. Por último, el Artículo 100 de la Ley de Seguridad Social manifiesta la prohibición de exoneración de intereses y multas.
...
\caption{Valores a tranferir al Fondo del Seguro IVM por Jubilación Especial de la Industria del Cemento}\\
