...
REP_tit <- 'Estudio Actuarial de la Sostenibilidad de la Jubilación Especial de los Trabajadores de la Industria del Cemento'
REP_nom_seg <- 'Jubilación Especial de los Trabajadores de la Industria del Cemento'
...
REP_fec_val <- format( ymd( '2022-12-31' ), '%Y-%m-%d' )
