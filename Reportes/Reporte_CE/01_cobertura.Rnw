...
\parbox{\textwidth}{ 
  ...
  {\begin{center} \fontsize{22pt}{30} { \selectfont{ \bfseries{ \textcolor{iess_blue} 
    { \Sexpr{REP_tit} } } } \par } \end{center} } 
}
...
\vspace{1.3cm}
\begin{flushright}
\hspace*{7cm}{\fontsize{15}{18}{\bfseries{\selectfont{\textcolor{iess_blue}{Quito - Julio 2024}}}}}
\end{flushright}
\normalfont
\clearpage
