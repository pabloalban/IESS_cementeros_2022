...
De acuerdo con el literal d) del artículo 8 del Reglamento de Aplicación de la Ley de Jubilación Especial de los Trabajadores de la Industria del Cemento, expedido mediante \legalcite{ResIESS_CD640}, se determina el calculo de la reserva matemática dentro del proceso para acceder a la jubilación especial, con las siguientes palabras: 
...
Por otro lado, la renta diferida utiliza la siguiente expresción matemática:
